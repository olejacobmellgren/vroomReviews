describe('Review cars', () => {
  it('Review cars carpage and delete', () => {
    ...
    cy.get('textarea').type('This is a successful test review for 812 Superfast')
    ...
    cy.contains('This is a successful test review for 812 Superfast').should('exist')
    ...
    // Check if review is added
    cy.contains('Your review').should('exist')
    cy.contains('This is a successful test review for Portofino M').should('exist')
    ...
    cy.contains('This is a successful test review for 812 Superfast').should('not.exist')
    cy.contains('My Reviews').click()
    cy.url().should('include', 'reviewedcars')
    ...
    cy.contains('Your review').should('not.exist')
    cy.contains('This is a successful test review for Portofino M').should('not.exist')
    cy.contains('My Reviews').click()
    cy.url().should('include', 'reviewedcars')
